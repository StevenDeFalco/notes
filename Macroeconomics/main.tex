...
The money market is controlled by the \define{Federal Reserve Bank} (Fed). The \define{Federal Reserve Bank} is an institution designed to oversee the banking system and regulate the money supply. The Federal Reserve Bank measures the money supply in the US with \define{transactions money} (M1) and \define{broad money} (M2). 
...
\define{Assets} are things a firm owns that are worth something. A bank's assets are its loans, vault cash, and reserve dposits at the Federal Reserve. Bank \define{reserves} are the deposits that a bank has at the Federal Reserve Bank plus its vault cash on hand. \define{Liabilities} are the firm's debts---what it owes. A bank's liabilities are deposits owed to customers. Net worth is assets $-$ liabilities, the difference between what the firm owns and what it owes. Banks are legally required to hold a certain minimum percentage of their deposit liabilities as reserves. 

\begin{definition}[Required Reserve Ratio (rr)]
...
\begin{enumerate}
  \item $rr$ (required reserve ratio)
    ...
    \end{itemize} 
  \item \define{Discount rate} is the interest rate that banks pay tot he Federal Reserve to borrow from it 
    \begin{itemize}
    ...
    \end{itemize}
  \item \define{Open market operations} are the purchase and sale by the Federal Reserve Bank of government securities in the open market
    \begin{itemize}
...
Banks borrow not only from the Federal Reserve Bank, but also from each other. The interest rates for these loans is called the \define{federal funds rate}. The \define{prime value} is the benchmark that banks use in quoting interest rates to customers; prime value differs according to the risk. 

\begin{remark}
  The discount rate is 5.5. The federal funds rate is 5.33. The prime rate is 8.5
\end{remark}

When the government has greater spendings than earnings, we say that it is running in a \define{deficit}. To pay for its bills, the government issues securities. The two types of securities are as follows:
\begin{itemize}
  \item Those that mature in less than a year are called \define{Treasury Bills} (T-Bills)
  \item Those with terms on year or more are called \define{Government Bonds}
\end{itemize}
...
The \define{Determinants of Money Demand} are as follows: 
\begin{enumerate}
  \item \define{Interest Rate}
    \begin{itemize}
    ...
    \end{itemize}
  \item \define{Price Level} (P) \emph{aka} the Consumer Price Index. If the price level changes, the demand for money changes in the same direction
    \begin{itemize}
...
At an \define{equilibrium interest rate}, the demand for money is equal to the supply of money. \\ 

If the Federal Reserve Bank wants to \bold{reduce the equilibrium interest rate}, then they need to \emph{increase the money supply}; this can be achieved by reducing the $rr$, reducing the discount rate, or purchasing securities (expansionary monetary policy. If the Federal Reserve Bank wants to \bold{increase the equilibrium interest rate}, then they need to \emph{decrease the money supply}; this can be achieved by increasing the $rr$, increasing the discount rate, or selling securities (contractionary monetary policy). \\ 

\section{Goods Market and Money Market Combined}

Money demand is dependent on the \bold{price level} and \bold{GDP}. If the price level increases, then the demand for money increases as well. If the GDP increases, the demand for money increases as well. \emph{The converses are true as well.} \\ 

If the \bold{interest rate is high}, then the \bold{level of investment is low} (because it is expensive to borrow money). If the \bold{interest rate is low}, then the \bold{level of investment is high} (because it is cheaper to borrow money). \\ 
...
\begin{enumerate}
  \item \define{Expansionary fiscal policy}: taxes decrease and/or government spending increases and thus the GDP ($Y$) increases 
    \begin{itemize}
    ...
    \end{itemize}
    The \define{Grouding out effect} is the tendency for increases in government spending to cause reduction in investment. This effect can be avoided if the Federal Reserve raises the money supply to keep the interest rate constant!
  \item \define{Contractionary fiscal policy}: taxes increase and/or government spending decrease and thus the GDP ($Y$) decreases. 
    \begin{itemize}
  ...
  \item \define{Expansionary Monetary Policy}: increase in the money supply (Federal Reserve purchases securities, reduces required reserve ratio, reduces the discount rate). 
    \begin{itemize}
  ...
  \item \define{Contractionary Monetary Policy}: decrease in the money supply (Federal Reserve sells securities, increases required reserve ratio, increase the discount rate). 
    \begin{itemize}
...
\define{Aggregate Demand} (AD) is the total demand for goods and services in an economy. The \define{AD-curve} shows the negative relationship between aggregate output (Y) and the price level (P). Suppose the price level increases, then the demand for money increases, interest rate increases, investment decreases, aggregate expenditure decreases, and the GDP decreases. 
\begin{itemize}
...
\define{Aggregate Supply} (AS) is the total supply of all goods and services in the economy. The \define{aggregate supply curve} shows the relation between the price level (P) and the aggregate output. 
\begin{itemize}
...
Suppose that the \bold{aggregate demand increases}. This can be caused with an expansionary fiscal policy (government spending increases and/or taxation decreases) or an expansionary monetary policy (required reserve ratio decreases, discount rate decreases, purchase of securities). Then, the GDP (Y) increases and the price level (P) also increases. Thus, if the \bold{aggregate demand increases}, then there is \bold{inflation} (price level increases) and the \bold{economy grows} (GDP increases). $$AD \uparrow \; \Rightarrow \; Y \uparrow , P \uparrow$$
...
Suppose there is a \bold{supply shock} into the economy. Examples of this include increases in wages, increases in energy prices, increases in oil prices, etc$\dots$ Then the Aggregate Supply curve will shift to the left: aggregate supply decreases. The result will be an increase in the price level (inflation) and a decrease in the GDP (Y). $$AS \downarrow \; \Rightarrow \; P \uparrow, Y \downarrow$$ \emph{Stagflation} is when there is inflation and a recession (GDP decreases) at the same time. \\ 

Suppose now that the Federal Reserve Bank follows an \bold{expansionary monetary policy} following some supply shock. The expansionary policy will have the effect of increasing the Aggregate Demand ($AD\uparrow$). Thus, as we known GDP increases and price level increases (inflation). The net effect of the supply shock and then following expansionary monetary policy will be \bold{doubly increased price levels} (inflation), but a relatively \bold{steady GDP} (or at least not recession). \\ 

Now, on the contrary, suppose that the Federal Reserve Banks follows a \bold{contractionary monetary policy} following some supply shock. The contractionary policy will have the effect of decreasing the Aggregate Demand ($AD\downarrow$). Thus, we know that the GDP decreases and the price level decreases (deflation) and the GDP decreases (recession). The net effect of the supply shock and following contractionary monetary policy will be \bold{no real inflation}, but put the \bold{economy further into recession}. 
