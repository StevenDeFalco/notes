...
\begin{itemize}
  \item A \define{price ceiling} is the maximum price sellers are allowed to charge for a good or service (e.g. rent control): usually set \emph{below} equilibrium 
    \begin{itemize}
      ...
      \item A \define{black market} is a market in which goods or services are bought and sold illegally---either because they are prohibited or because the equilibrium price is illegal. Black markets encourage disrespect for the law and worses the position of whose who are outside the market. 
    \end{itemize}
