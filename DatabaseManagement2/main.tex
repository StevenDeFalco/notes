...
A schedule is \define{serializable} if it is equivalent to a serial scheduler (i.e. a concurrent schedule that can be transformed into an equivalent serial schedule). Instructions will \bold{conflict} if there are writes in any of the insturctions. 
