...
\begin{theorem}
  The class of regular languages is closed under the union operation. In other wrods, if $A,B$ are both regular langauges then $A \cup B$ is regular as well.  
\end{theorem}
